...
if(!(BivD %in% c("AMH","FGM","PL","HO","GAL"))) i.rho <- BiCopTau2Par(family = nCa, tau = ass.s)
...
if(  BivD %in% c("GAL") )                  i.rho <- as.numeric(iTau(galambosCopula(), ass.s))
...
if(BivD %in% c("C0","C180","C90","C270",
               "C0C90","C0C270","C180C90","C180C270","GAL"))             i.rho <-  log(i.rho)   
